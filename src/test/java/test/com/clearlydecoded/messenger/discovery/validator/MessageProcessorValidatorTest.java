...
import com.clearlydecoded.messenger.discovery.MessageProcessorValidator;
...
public class MessageProcessorValidatorTest {
  ...
  @Test
  public void testValidateMessageProcessor() {
    MessageProcessorValidator.validateMessageProcessor(new MockMessageProcessor());
  }
  ...
  @Test(expected = IllegalStateException.class)
  public void testValidateMessageProcessorBadMessage() {
    MessageProcessorValidator
        .validateMessageProcessor(new BadMockMessageProcessor());
  }
